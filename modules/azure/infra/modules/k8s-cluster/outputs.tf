...
output "private_fqdn" {
  description = "Private FQDN of the API server. Set only when private_cluster_enabled = true. Used by operators on a jump-host that resolves via the hub's DNS resolver."
